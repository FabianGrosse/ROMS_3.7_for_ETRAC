...
**
** svn $Id: cppdefs.h 851 2017-06-23 23:22:54Z arango $
********************************************************** Hernan G. Arango ***
...
**                                                                           **
** Simple oxygen sink model OPTIONS:                                         **
**                                                                           **
** BIO_OXYSINK         use if simple oxygen sink model                       **
** BIO_SOD             use Hetland & DiMarco (2008) SOC parameterization     **
**                                                                           **
** Hydrocarbon model OPTIONS:                                                **
**                                                                           **
** BIO_HYDROCARBON     use if hydrocarbon model                              **
** OIL_SPILL           use to add hydrocarbon (oil) to the model             **
**                                                                           **
