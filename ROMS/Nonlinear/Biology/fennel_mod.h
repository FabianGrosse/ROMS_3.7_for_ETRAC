...
#ifdef RIVER_PON
      integer :: iRDeN                  ! Small detritus N-concentration
#endif
#ifdef CARBON
...
# ifdef OXYGEN_VIRT
      integer :: iOxyV                  ! Dissolved virtual oxygen concentration
# endif
#endif
...
# ifdef OXYGEN_VIRT
      integer  :: iO2vf                       ! air-sea flux of virtual O2
# endif
!
...
#ifdef CARBON
# ifdef OXYGEN
#  if defined PO4 && defined RIVER_PON
      NBT=15
#  elif defined PO4 || defined RIVER_PON
      NBT=14
#  else
      NBT=13
#  endif
