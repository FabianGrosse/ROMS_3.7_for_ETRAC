...
# ifdef OXYGEN_VIRT
              CASE ('idTbry(iwest,iOxyV)')
                idTbry(iwest,iOxyV)=varid
              CASE ('idTbry(ieast,iOxyV)')
                idTbry(ieast,iOxyV)=varid
              CASE ('idTbry(isouth,iOxyV)')
                idTbry(isouth,iOxyV)=varid
              CASE ('idTbry(inorth,iOxyV)')
                idTbry(inorth,iOxyV)=varid
# endif
#endif
# ifdef RIVER_PON
